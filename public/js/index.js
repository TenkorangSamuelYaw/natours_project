...
})({"lqPnn":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1a79dda26e293269";
"use strict";
...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // Sign up form functionality
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alerts.js":"ccxpI"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ccxpI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kcMzV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const initSignup = ()=>{
    document.addEventListener('DOMContentLoaded', function() {
        ...
        cancelSecretBtn?.addEventListener('click', function() {
            ...
            document.querySelector('.radio-item')?.classList.add('selected');
            document.querySelector('input[value="admin"]')?.closest('.radio-item')?.classList.remove('selected');
            selectedAdminRole = false;
            secretCodeInput.value = '';
            hideAdminModal();
        });
        adminModal?.addEventListener('click', function(e) {
            if (e.target === adminModal) cancelSecretBtn?.click();
        });
        adminSecretInput?.addEventListener('keypress', function(e) {
            if (e.key === 'Enter') confirmSecretBtn?.click();
        });
        const signup = async (name, email, password, confirmPassword, role, secretCode, avatarFile)=>{
        ...
        signupForm?.addEventListener('submit', function(e) {
            ...
            signup(fullName, email, password, confirmPassword, role, secretCode, avatarFile);
        });
    });
};
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1Ijoic3l0ZW5rb3JhbmciLCJhIjoiY21jMzlvbDFlMDJtZjJtczh5cGw3bHJ5aiJ9.h21y9iPUi8dvKw0UiM3MTg';
    const map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/sytenkorang/cmc451ga8020j01sc1ru2b225',
        scrollZoom: false
    });
...
},{}]},["lqPnn","ebWYT"], "ebWYT", "parcelRequire11c7", {})
