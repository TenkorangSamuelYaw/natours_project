...
import { uploadUserPhoto, resizeUploadedPhoto } from '../controllers/fileUploadController.js';
...
router.post('/signup', uploadUserPhoto, resizeUploadedPhoto, handleMulterError, signUp);
...
router.patch('/updateMe', uploadUserPhoto, resizeUploadedPhoto, handleMulterError, updateMe);
